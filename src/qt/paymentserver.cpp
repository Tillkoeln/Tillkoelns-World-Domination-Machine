...
const QString BITCOIN_IPC_PREFIX("FugueCore:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click FugueCore: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start FugueCore: click-to-pay handler");
    else
...
{
    // clicking on FugueCore: URLs creates FileOpen events on the Mac:
